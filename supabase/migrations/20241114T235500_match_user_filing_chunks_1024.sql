-- =================================================================
-- Migration: Update match_user_filing_chunks for Cohere (1024 dims)
-- Date: 2024-11-14
-- =================================================================
...
create or replace function public.match_user_filing_chunks(
  ...
  p_filing_ids bigint[] default null,
...
comment on function public.match_user_filing_chunks is 'Per-user pgvector similarity search across filing_chunks with optional metadata filters (1024-d embeddings).';
