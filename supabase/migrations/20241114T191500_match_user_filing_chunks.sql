-- =================================================================
-- Migration: match_user_filing_chunks helper for vector retrieval
-- Date: 2024-11-14
-- =================================================================
...
comment on function public.match_user_filing_chunks is 'Per-user pgvector similarity search across filing_chunks with optional metadata filters.';
